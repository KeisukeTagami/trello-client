...
-- | display the config
instance P.Show TrelloConfig where
  show c =
    T.printf
...
-- | constructs a default TrelloConfig
--
-- configHost:
--
-- @https://trello.com/1@
...
-- @"trello/0.1.0.0"@
--
newConfig :: IO TrelloConfig
newConfig = do
    logCxt <- initLogContext
    return $ TrelloConfig
        { configHost = "https://trello.com/1"
        , configUserAgent = "trello/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => TrelloConfig -> auth -> TrelloConfig
addAuthMethod config@TrelloConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: TrelloConfig -> IO TrelloConfig
...
withStderrLogging :: TrelloConfig -> IO TrelloConfig
...
withNoLogging :: TrelloConfig -> TrelloConfig
...
data TrelloRequest req contentType res accept = TrelloRequest
  { rMethod  :: NH.Method   -- ^ Method of TrelloRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of TrelloRequest
  , rParams   :: Params -- ^ params of TrelloRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (TrelloRequest req contentType res accept) NH.Method
rMethodL f TrelloRequest{..} = (\rMethod -> TrelloRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (TrelloRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f TrelloRequest{..} = (\rUrlPath -> TrelloRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (TrelloRequest req contentType res accept) Params
rParamsL f TrelloRequest{..} = (\rParams -> TrelloRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (TrelloRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f TrelloRequest{..} = (\rAuthTypes -> TrelloRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => TrelloRequest req contentType res accept -> param -> TrelloRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: TrelloRequest req contentType res accept -> param -> TrelloRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: TrelloRequest req contentType res accept -> param -> TrelloRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method 
          ...
          -> TrelloRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = TrelloRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: TrelloRequest req contentType res accept -> [NH.Header] -> TrelloRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: TrelloRequest req contentType res accept -> [NH.HeaderName] -> TrelloRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => TrelloRequest req contentType res accept -> TrelloRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => TrelloRequest req contentType res accept -> TrelloRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: TrelloRequest req contentType res accept -> [NH.QueryItem] -> TrelloRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: TrelloRequest req contentType res accept -> WH.Form -> TrelloRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: TrelloRequest req contentType res accept -> NH.Part -> TrelloRequest req contentType res accept
...
_setBodyBS :: TrelloRequest req contentType res accept -> B.ByteString -> TrelloRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: TrelloRequest req contentType res accept -> BL.ByteString -> TrelloRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => TrelloRequest req contentType res accept -> P.Proxy authMethod -> TrelloRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: TrelloConfig
    -> a
    -> TrelloRequest req contentType res accept
    -> IO (TrelloRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> TrelloConfig
  -> IO (TrelloRequest req contentType res accept)
_applyAuthMethods req config@(TrelloConfig {configAuthMethods = as}) =
  foldlM go req as
  where
