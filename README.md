## Swagger Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Trello` 

The library in `lib` provides auto-generated-from-Swagger [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Trello API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Trello                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | trello                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | TrelloConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | TrelloRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Trello.Client    | use the "dispatch" functions to send requests       |
| Trello.Core      | core funcions, config and request types             |
| Trello.API       | construct api requests                              |
| Trello.Model     | describes api models                                |
| Trello.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Trello.ModelLens | lenses for model fields                             |
| Trello.Logging   | logging functions and utils                         |
