...
module Trello.API.ApiType where
...
getTypesById 
  ...
  -> TrelloRequest GetTypesById MimeNoContent NoContent MimeNoContent
getTypesById (Id id) (Key key) (Token token) =
  _mkRequest "GET" ["/types/",toPath id]
